...
function astToReact(node, options, parent = {}, index = 0) {
  ...
  // nodes generated by plugins may not have position - setting to node parent's position
  // TODO: there should be a way to get and assign a node's position after parse
  if(node.position === undefined) {
    visit(root, node, (nodeVisit, indexVisit, parentVisit) => {
      ...
      node.position = parentVisit.position || defaultPosition;
    })
  }
...
function getNodeProps(node, key, opts, renderer, parent, index) {
  ...
  if (opts.rawSourcePos && !isTagRenderer) {
    // nodes generated by plugins do not have position - setting to an empty default object
